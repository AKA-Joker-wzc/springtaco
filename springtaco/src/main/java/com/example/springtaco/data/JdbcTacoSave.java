...
@Repository
public class JdbcTacoSave implements TacoSave{
    private JdbcTemplate jdbc;
    public JdbcTacoSave(JdbcTemplate jdbc){
        this.jdbc = jdbc;
    }
    ...
    private long saveTacoInfo(Taco taco){
        ...
        PreparedStatementCreator psc = new PreparedStatementCreatorFactory("insert into Taco(name , createdAt) values(?,?)" , Types.VARCHAR,Types.TIMESTAMP).newPreparedStatementCreator(Arrays.asList(
